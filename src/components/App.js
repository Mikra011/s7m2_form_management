...
export default function App() {
  ...
  // b) prevent further action if either username or email or role is an empty string after trimming
  ...
  axios.post('fakeapi.com', newFriend)
    .then(res => {
      // Assuming the response contains the newly created friend object
      const createdFriend = res.data

      // Update friends state by adding the newly created friend
